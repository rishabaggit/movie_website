...
$sql = "SELECT moviename, starttime, seatnum, hall, id FROM tickets WHERE username = ?";
...
if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
                // Store result
                mysqli_stmt_bind_result($stmt, $moviename, $starttime, $seats, $hall, $id);
...
<body>
        ...
        <p>
                <a href="welcome.php" class="btn btn-info">Go Back to Browse Movies</a>
